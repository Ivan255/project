...
(function(){
    ...
    Draw.prototype.face = function(){
        var width = height = 800;
        var eyeRadius = width/7;
        var centerPoint = {
            x:eyeRadius*2,
            y:eyeRadius*2
        };
        ...
        var endAngle = 0;
        //左眼
        this.round(centerPoint.x,centerPoint.y,radius,startAngle,endAngle,false,"black",true);
        //右眼
        this.round(eyeRadius*5,centerPoint.y,radius,startAngle,endAngle,false,"black",true);

        //嘴巴
        var mouseRedius = eyeRadius*5/2;
        centerPoint.x = width/2;
        centerPoint.y = height/2;
        this.round(centerPoint.x,centerPoint.y,mouseRedius,startAngle,endAngle,true,"black",true);
    };
