...
(function(){
    ...
    function init(){
        var button = document.querySelector(".drawButton");
        button.onclick = function(){
            this.textContent == "绘制" ? painter.isDrawLine = false:painter.isDrawLine = true;
            this.textContent = this.textContent == "绘制"?"擦除":"绘制";
        }
